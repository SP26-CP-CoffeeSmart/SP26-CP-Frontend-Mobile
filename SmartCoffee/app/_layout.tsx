...
function RootLayoutNav() {
  ...
  useEffect(() => {
    ...
    const nestedScreens = ['change-password', 'recipe-detail', 'menu-detail', 'ai-loading', 'ai-recommendations', 'ai-result', 'ai-order-suggestions', 'staff-management', 'create-staff', 'create-recipe', 'menu-recommendations', 'menu-results', 'ingredient-detail', 'daily-sales', 'daily-sale-item'];
